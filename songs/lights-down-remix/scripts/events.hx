...
function beatHit(curBeat){
	...
	switch(curBeat){
		...
		case 220:
			FlxTween.tween(bar1, {x: 1080}, Conductor.crochet/850, {ease:FlxEase.circIn, onComplete: function(){
				add(bar1);
			}});
			FlxTween.tween(bar2, {x: 0}, Conductor.crochet/850, {ease:FlxEase.circIn, onComplete: function(){
				add(bar2);
			}});
